...
export default function SEOSettings() {
  const [activeTab, setActiveTab] = useState<'pages' | 'global' | 'code-injection'>('pages')
  ...
  const generateSEOSuggestions = async () => {
    ...
    try {
      ...
      setPageForm(prev => ({
        ...
        twitter_description: prev.twitter_description || suggestions.twitter_description,
      ...
      showMessage('error', error.message || 'Failed to generate SEO suggestions')
    } finally {
  ...
  const handleCreateSelectedPages = async () => {
    ...
    try {
      ...
      showMessage('success', `Created ${result.created_count} SEO configurations successfully`)
  ...
  const generateSchemaTemplate = (type: string) => {
    ...
    return JSON.stringify(templates[type as keyof typeof templates] || templates.website, null, 2)
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600">Manage meta tags, schema markup, and code injection</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Pages Configured</p>
              <p className="text-2xl font-bold text-gray-900">{pagesSEO.length}</p>
            </div>
          ...
          <div className="mt-4 flex items-center">
            <span className="text-sm font-medium text-gray-600">Total configured</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Code Injection</p>
              <p className="text-2xl font-bold text-gray-900">
                {(globalSettings.header_code ? 1 : 0) + (globalSettings.body_code ? 1 : 0) + (globalSettings.footer_code ? 1 : 0)}
              </p>
            </div>
          ...
          {activeTab === 'pages' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col space-y-4 lg:flex-row lg:space-y-0 lg:items-center lg:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Page-Specific SEO</h3>
                  <p className="text-sm text-gray-600">Configure meta tags, schema markup, and social media settings for individual pages</p>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Default settings that apply to all pages unless overridden</p>
                </div>
                <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, site_name: e.target.value }))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, default_meta_title: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                      placeholder="Default meta title"
                    />
                    <p className="text-xs text-gray-500 mt-1">{globalSettings.default_meta_title.length}/60 characters</p>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, default_meta_description: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                      rows={3}
                      placeholder="Default meta description"
                    />
                    <p className="text-xs text-gray-500 mt-1">{globalSettings.default_meta_description.length}/160 characters</p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, default_og_image: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, favicon_url: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                ...
                {/* Analytics & Social */}
                <div className="space-y-4">
                  <h4 className="text-md font-medium text-gray-900">Analytics & Social</h4>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, google_analytics_id: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, google_search_console_id: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, twitter_site: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGlobalSettings(prev => ({ ...prev, sitemap_url: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
              ...
              <div className="space-y-6 mt-8">
                <div className="border-t border-gray-200 pt-6">
                  <h4 className="text-md font-medium text-gray-900 mb-4">Global SEO Defaults</h4>
                  <p className="text-sm text-gray-600 mb-6">
                    These settings will be used as defaults for all pages unless overridden by page-specific settings.
                  </p>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setGlobalSettings(prev => ({ ...prev, default_canonical_url: e.target.value }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                          placeholder="https://99group.games"
                        />
                        <p className="text-xs text-gray-500 mt-1">Leave empty to use relative URLs</p>
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          value={globalSettings.default_robots_meta || 'index, follow'}
                          onChange={(e) => setGlobalSettings(prev => ({ ...prev, default_robots_meta: e.target.value }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setGlobalSettings(prev => ({ ...prev, default_keywords: e.target.value }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <button
                            onClick={() => setGlobalSettings(prev => ({ 
                              ...prev, 
                              default_schema_markup: generateSchemaTemplate('website') 
                            }))}
                          ...
                          <button
                            onClick={() => setGlobalSettings(prev => ({ 
                              ...prev, 
                              default_schema_markup: generateSchemaTemplate('blogpost') 
                            }))}
                          ...
                          <button
                            onClick={() => setGlobalSettings(prev => ({ 
                              ...prev, 
                              default_schema_markup: generateSchemaTemplate('organization') 
                            }))}
                        ...
                        <textarea
                          ...
                          onChange={(e) => setGlobalSettings(prev => ({ ...prev, default_schema_markup: e.target.value }))}
  ...
  "description": "Premium gaming platform"
                        ...
                        <div className="flex items-center justify-between mt-2">
                          <span className="text-xs text-gray-500">{globalSettings.default_schema_markup?.length || 0} characters</span>
                          <div className="flex items-center space-x-2">
                            <button
                              onClick={() => {
                                try {
                                  if (globalSettings.default_schema_markup) {
                                    JSON.parse(globalSettings.default_schema_markup)
                            ...
                            {globalSettings.default_schema_markup && (
                              <button
                                onClick={() => copyToClipboard(globalSettings.default_schema_markup || '')}
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-blue-800">Priority Override System</h4>
                        <p className="text-sm text-blue-700 mt-1">
                          These global defaults will be used when page-specific SEO settings are not configured. 
                          Page-level settings always take priority over global settings.
                        </p>
                        <ul className="text-sm text-blue-700 mt-2 space-y-1">
                          <li>• <strong>Priority 1:</strong> Page-specific SEO settings</li>
                          <li>• <strong>Priority 2:</strong> Global default settings</li>
                          <li>• <strong>Priority 3:</strong> System fallback values</li>
                        </ul>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === 'code-injection' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Code Injection</h3>
                  <p className="text-sm text-gray-600">Add custom HTML, CSS, JavaScript, or tracking codes to all pages</p>
                </div>
                <button
                  onClick={handleSaveGlobal}
                  disabled={saving}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h4 className="text-md font-medium text-gray-900">Header Code</h4>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Code added here will be injected into the &lt;head&gt; section of all pages. Perfect for meta tags, CSS, analytics, or tracking scripts.
                  </p>
                  <textarea
                    value={globalSettings.header_code}
                    onChange={(e) => setGlobalSettings(prev => ({ ...prev, header_code: e.target.value }))}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent font-mono text-sm"
                    rows={8}
...
<style>
  .custom-style { color: #333; }
                  ...
                  />
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-xs text-gray-500">{globalSettings.header_code.length} characters</span>
                    {globalSettings.header_code && (
                      <button
                        onClick={() => copyToClipboard(globalSettings.header_code)}
                        className="text-xs text-blue-600 hover:text-blue-800 transition-colors"
                      >
                        Copy Code
                      </button>
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h4 className="text-md font-medium text-gray-900">Body Code</h4>
                    <div className="flex items-center space-x-1 text-xs text-gray-500 bg-gray-200 px-2 py-1 rounded">
                      <Info className="w-3 h-3" />
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Code added here will be injected right after the opening &lt;body&gt; tag. Ideal for tracking pixels, chat widgets, or JavaScript that needs to load early.
                  </p>
                  <textarea
                    value={globalSettings.body_code}
                    onChange={(e) => setGlobalSettings(prev => ({ ...prev, body_code: e.target.value }))}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent font-mono text-sm"
                    rows={8}
...
<div id="chat-widget"></div>`}
                  />
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-xs text-gray-500">{globalSettings.body_code.length} characters</span>
                    {globalSettings.body_code && (
                      <button
                        onClick={() => copyToClipboard(globalSettings.body_code)}
                        className="text-xs text-blue-600 hover:text-blue-800 transition-colors"
                      >
                        Copy Code
                      </button>
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h4 className="text-md font-medium text-gray-900">Footer Code</h4>
                    <div className="flex items-center space-x-1 text-xs text-gray-500 bg-gray-200 px-2 py-1 rounded">
                      <Info className="w-3 h-3" />
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Code added here will be injected right before the closing &lt;/body&gt; tag. Best for JavaScript that should load after page content, like analytics or performance scripts.
                  </p>
                  <textarea
                    value={globalSettings.footer_code}
                    onChange={(e) => setGlobalSettings(prev => ({ ...prev, footer_code: e.target.value }))}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent font-mono text-sm"
                    rows={8}
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // Initialize your app
                  ...
                  />
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-xs text-gray-500">{globalSettings.footer_code.length} characters</span>
                    {globalSettings.footer_code && (
                      <button
                        onClick={() => copyToClipboard(globalSettings.footer_code)}
                        className="text-xs text-blue-600 hover:text-blue-800 transition-colors"
                      >
                        Copy Code
                      </button>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-yellow-700 mt-2 space-y-1">
                        <li>• Test all injected code thoroughly before deploying to production</li>
                        <li>• Malformed HTML/JavaScript can break your entire site</li>
                        <li>• Use proper script tags and ensure all tags are properly closed</li>
                        <li>• Consider page load performance when adding tracking scripts</li>
            ...
            <div className="space-y-6">
                  ...
                  <div className="ml-6 space-y-4">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-blue-800">Smart SEO Suggestions</h4>
                          <p className="text-sm text-blue-700 mt-1">
                            After entering the page path, use the "Smart Fill" button above to auto-fill empty fields, or use "Auto Fill All" to replace all fields.
                            Suggestions are intelligently generated based on your global SEO settings and page type.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setPageForm(prev => ({ ...prev, page_path: e.target.value }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                          placeholder="/about"
                        />
                      </div>
                    ...
                    <div>
                        ...
                        <button
                          onClick={async () => {
                            ...
                            try {
                              ...
                              if (response.ok) {
                                const data = await response.json()
                                setPageForm(prev => ({ ...prev, meta_title: data.suggestions.meta_title }))
                              }
                            } catch (error) {
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">{pageForm.meta_title?.length || 0}/60 characters</p>
                    </div>
                    ...
                    <div>
                        ...
                        <button
                          onClick={async () => {
                            ...
                            try {
                              ...
                              if (response.ok) {
                                const data = await response.json()
                                setPageForm(prev => ({ ...prev, meta_description: data.suggestions.meta_description }))
                              }
                            } catch (error) {
                              console.error('Error generating suggestion:', error)
                            } finally {
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">{pageForm.meta_description?.length || 0}/160 characters</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setPageForm(prev => ({ ...prev, robots_meta: e.target.value }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                        >
                          <option value="index, follow">Index, Follow</option>
                          <option value="noindex, follow">No Index, Follow</option>
                        ...
                        <button
                          onClick={async () => {
                            ...
                            try {
                              ...
                              if (response.ok) {
                                const data = await response.json()
                                setPageForm(prev => ({ ...prev, keywords: data.suggestions.keywords }))
                              }
                            } catch (error) {
                              console.error('Error generating suggestion:', error)
                            } finally {
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <h4 className="text-md font-medium text-gray-900">Social Media (Open Graph & Twitter)</h4>
                </button>
                ...
                {expandedSections.includes('social') && (
                  <div className="ml-6 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {/* Open Graph */}
                      <div className="space-y-4">
                        <h5 className="text-sm font-medium text-gray-900">Open Graph (Facebook)</h5>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setPageForm(prev => ({ ...prev, og_title: e.target.value }))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                            placeholder="About Us"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => setPageForm(prev => ({ ...prev, og_description: e.target.value }))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                            rows={3}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setPageForm(prev => ({ ...prev, og_image: e.target.value }))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                      ...
                      {/* Twitter */}
                      <div className="space-y-4">
                        <h5 className="text-sm font-medium text-gray-900">Twitter Card</h5>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setPageForm(prev => ({ ...prev, twitter_title: e.target.value }))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                            placeholder="About Us"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => setPageForm(prev => ({ ...prev, twitter_description: e.target.value }))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                            rows={3}
                            placeholder="Learn more about our company..."
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setPageForm(prev => ({ ...prev, twitter_image: e.target.value }))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <h4 className="text-md font-medium text-gray-900">Schema Markup (JSON-LD)</h4>
                </button>
                ...
                {expandedSections.includes('schema') && (
                  <div className="ml-6 space-y-4">
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      <button
                        onClick={() => setPageForm(prev => ({ ...prev, schema_markup: generateSchemaTemplate('website') }))}
                        className="text-xs px-2 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200 transition-colors"
                      >
                        Website
                      </button>
                      <button
                        onClick={() => setPageForm(prev => ({ ...prev, schema_markup: generateSchemaTemplate('article') }))}
                        className="text-xs px-2 py-1 bg-green-100 text-green-700 rounded hover:bg-green-200 transition-colors"
                      >
                        Article
                      </button>
                      <button
                        onClick={() => setPageForm(prev => ({ ...prev, schema_markup: generateSchemaTemplate('blogpost') }))}
                        className="text-xs px-2 py-1 bg-orange-100 text-orange-700 rounded hover:bg-orange-200 transition-colors"
                      >
                        Blog Post
                      </button>
                      <button
                        onClick={() => setPageForm(prev => ({ ...prev, schema_markup: generateSchemaTemplate('organization') }))}
                        className="text-xs px-2 py-1 bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors"
                      >
                        Organization
                      </button>
                    ...
                    <div>
                        ...
                        <button
                          onClick={async () => {
                            ...
                            try {
                              ...
                              if (response.ok) {
                                const data = await response.json()
                                setPageForm(prev => ({ ...prev, schema_markup: data.suggestions.schema_markup }))
                              }
                            } catch (error) {
                              console.error('Error generating suggestion:', error)
                            } finally {
                      ...
                      <textarea
                        ...
                        onChange={(e) => setPageForm(prev => ({ ...prev, schema_markup: e.target.value }))}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent font-mono text-sm"
                        rows={12}
                        placeholder={`{
  "@context": "https://schema.org",
  ...
  "url": "https://yoursite.com/page"
                      ...
                      />
                      <div className="flex items-center justify-between mt-2">
                        <span className="text-xs text-gray-500">{pageForm.schema_markup?.length || 0} characters</span>
                        <div className="flex items-center space-x-2">
                          <button
                            onClick={() => {
                              try {
                          ...
                          {pageForm.schema_markup && (
                            <button
                              onClick={() => copyToClipboard(pageForm.schema_markup || '')}
                              className="text-xs text-gray-600 hover:text-gray-800 transition-colors"
                            >
                              Copy
                            </button>
      ...
      {showPreviewModal && previewPage && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold text-gray-900">SEO Preview - {previewPage.page_title}</h3>
              <button
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                  ...
                  <div className="text-green-600 text-sm mt-1">
                    {previewPage.canonical_url || `https://yoursite.com${previewPage.page_path}`}
                  </div>
                      ...
                      <div className="h-48 bg-gray-200 flex items-center justify-center">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            parent.innerHTML = '<div class="w-full h-full bg-gray-200 flex items-center justify-center"><span class="text-gray-400 text-sm">No Preview</span></div>'
                          }}
                        />
                      </div>
                    )}
              ...
              {previewPage.schema_markup && (
                <div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                    ...
                    <button
                      onClick={() => copyToClipboard(previewPage.schema_markup || '')}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Delete Page SEO</h3>
              <button
              ...
              <div className="flex items-center space-x-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-red-800">
                    Are you sure you want to delete SEO settings for <strong>"{deletingPage.page_title}"</strong>?
                  </p>
      ...
      {showSyncModal && syncData && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold text-gray-900">Sync Pages with SEO Settings</h3>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-blue-600">{syncData.summary.total_discovered}</p>
                  </div>
                </div>
              </div>
              <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-900">Has SEO Config</p>
                    <p className="text-xl font-bold text-green-600">{syncData.summary.existing_seo_configs}</p>
                  </div>
                </div>
              </div>
              <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-orange-900">New Pages</p>
                    <p className="text-xl font-bold text-orange-600">{syncData.summary.new_pages}</p>
                  </div>
                </div>
              </div>
              <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-red-600">{syncData.summary.orphaned_configs}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {syncData.new_pages && syncData.new_pages.length > 0 && (
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      onClick={() => setSelectedNewPages(syncData.new_pages.map((p: any) => p.page_path))}
                ...
                <div className="bg-orange-50 rounded-lg border border-orange-200 p-4">
                  <p className="text-sm text-orange-800 mb-4">
                    These pages exist in your application but don't have SEO configurations yet. Select which ones you'd like to create SEO settings for:
                  </p>
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {syncData.new_pages.map((page: any) => (
                      <label key={page.page_path} className="flex items-center space-x-3 p-2 hover:bg-orange-100 rounded">
                        <input
                          type="checkbox"
                          checked={selectedNewPages.includes(page.page_path)}
                          onChange={(e) => {
                            if (e.target.checked) {
                              setSelectedNewPages(prev => [...prev, page.page_path])
                            } else {
                              setSelectedNewPages(prev => prev.filter(p => p !== page.page_path))
                            }
                          }}
                        ...
                        <div className="text-xs text-gray-500 bg-white px-2 py-1 rounded">
                          {page.file_path.replace(/^.*\/nextjs-game-platform/, '').replace(/\\/g, '/')}
                        </div>
                      </label>
                    ))}
                  </div>
            ...
            {syncData.orphaned_configs && syncData.orphaned_configs.length > 0 && (
              <div className="mb-6">
                <h4 className="text-md font-medium text-gray-900 mb-4 flex items-center">
                  <AlertCircle className="w-4 h-4 mr-2 text-red-600" />
                  Orphaned SEO Configurations ({syncData.orphaned_configs.length})
                </h4>
                <div className="bg-red-50 rounded-lg border border-red-200 p-4">
                  <p className="text-sm text-red-800 mb-4">
                    These SEO configurations exist but their corresponding pages were not found. You may want to review and clean them up:
                  </p>
                  <div className="space-y-2 max-h-40 overflow-y-auto">
                    {syncData.orphaned_configs.map((config: any) => (
                      <div key={config.id} className="flex items-center justify-between p-2 bg-white rounded border border-red-200">
                        <div>
                          <div className="text-sm font-medium text-gray-900">{config.page_title}</div>
                          <div className="text-xs text-gray-600">{config.page_path}</div>
                        </div>
                        <button
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {syncData.discovered_pages.map((page: any) => (
                        <tr key={page.page_path}>
                          <td className="px-4 py-2 text-sm text-gray-900">{page.page_title}</td>
                          <td className="px-4 py-2 text-sm text-gray-600">{page.page_path}</td>
            ...
            <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
              ...
              {selectedNewPages.length > 0 && (
                ...
                >
                  ...
                  <span>Create SEO for {selectedNewPages.length} Page{selectedNewPages.length > 1 ? 's' : ''}</span>
                </button>
              )}
            </div>
          </div>
